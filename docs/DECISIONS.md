...
- DEC-S044 — `drift.mjs` gains a `presence` class — report the absence, never the contents _(extended by DEC-S046 — the same failure one layer up — S044 gave one unclassified file a class, this reports the fact of being unclassified; the four classes and their meanings are unchanged)_
