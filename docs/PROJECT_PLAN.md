...
**Total: 95 pts** (delivered through Task 16: 69 pts; remaining: Tasks 5, 6, 7, 8, 9, 17, 18, 19, 20, 21, 22, 23 — pending /its-dead reconciliation for 7 + 17 + 19 closing this session)

**Next session priority:** Tasks 20 + 21 (8 pts combined) — semver workflow + staging-flow conventions, designed and built together since they're entangled. Then Task 18 (sailbook V2 migration, 5 pts) before Task 22 propagates the new flow into sailbook. Task 23 (Supabase guard, 3 pts) likely pairs with Task 22 since both touch sailbook's staging adoption. Tasks 5, 6, 8, 9 stay deferred (Routine-flow work).
