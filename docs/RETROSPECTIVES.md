...
| 24 | 2026-05-14 | 3.77 | — | 13 | #38, #75 | DEC-013/014 ship |
| 25 | 2026-05-14 | — | — | 0 | — | Abandoned (web runner, no work shipped) |
| 26 | 2026-05-14 | 2.58 | — | 5 | #39, #40 | Tasks 29 + 30 + retro |

PR-derived columns left blank for most rows — pre-DEC-013 sessions didn't record `pr_numbers` in frontmatter. `gh pr list --state merged` confirms 34 total merges in the window.
...
- Task 33 (three time fields on frontmatter, shipped Session 23) was superseded by Task 34 (DEC-013/DEC-014, shipped Session 24). Counted as closed with a "superseded by Task 34" note in the plan; not scope creep.
