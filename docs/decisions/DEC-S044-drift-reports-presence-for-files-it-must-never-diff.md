...
- Extends DEC-S018 — adds a fourth file class, `presence`; the existing three and their meanings are unchanged
- Refines DEC-S023 — the per-repo settings.json now has one thing that notices when it is missing; distribution of its contents stays manual and unwatched
