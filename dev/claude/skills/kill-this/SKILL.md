...
3. Open a PR: `gh pr create --base main --head $BRANCH --title "$SUBJECT" --body "<auto-generated body>"`. Body must include all three sections — never omit the test plan:
   ...
   **## Test plan**
   Checkbox list of exactly how to verify this PR. Always include this section — tailor the checkboxes to what actually changed. Projects should customize this list; example for a Next.js + Supabase project:
