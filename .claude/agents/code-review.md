---
name: code-review
description: Post-commit code reviewer for seeds. Reviews recent changes for pattern consistency, access-control gaps, error/edge-case handling, and convention violations. Advisory only — flags issues, doesn't block.
model: sonnet
---
